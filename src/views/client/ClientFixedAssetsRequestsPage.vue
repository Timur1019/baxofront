...
async function submitAdd() {
  ...
  try {
    ...
    await createEvaluationRequestWithDocument(dto, null, null, fixedAssetsFile.value)
    closeAddModal()
    load()
  } catch (e) {
        ...
        <div class="modal-container modal-container--wide">
          <div class="modal-header">
            <h2 class="modal-title">
              <i class="bi bi-box-seam modal-title-icon"></i>
            ...
            <div class="modal-form__grid">
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">
                  {{ t('client.fixedAssets.propertyOwnerName') }} <span class="text-danger">*</span>
                </label>
                <input
              ...
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">
                  {{ t('client.fixedAssets.objectAddress') }} <span class="text-danger">*</span>
                </label>
                <input
              ...
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">
                  {{ t('client.fixedAssets.uploadDocuments') }} <span class="text-danger">*</span>
                </label>
              ...
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">
                  {{ t('client.fixedAssets.addPropertiesLabel') }} <span class="text-danger">*</span>
                </label>
                <div class="modal-form__properties-block">
                  <button type="button" class="btn btn-outline-primary btn-sm" @click="openPropertyModal">
                  ...
                  <div v-if="fixedAssetItems.length > 0" class="modal-form__properties-list">
                    ...
                    >
                      ...
                      <button type="button" class="btn btn-danger btn-sm" @click="removeProperty(idx)" title="Удалить">
      ...
      <div v-if="showPropertyModal" class="modal-overlay" @click.self="closePropertyModal">
        <div class="modal-container modal-container--narrow">
          ...
          <form class="modal-form" @submit.prevent="addProperty">
            <div class="modal-form__grid">
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">{{ t('client.fixedAssets.assetType') }}</label>
                <select v-model="propertyForm.assetType" class="form-select">
                  <option v-for="at in assetTypes" :key="at.value" :value="at.value">{{ t('client.' + at.labelKey) }}</option>
                </select>
              </div>
              <div class="modal-form__group modal-form__group--full">
                <label class="form-label">
                  {{ t('client.fixedAssets.propertyName') }} <span class="text-danger">*</span>
                </label>
                <input
              ...
              <div class="modal-form__group">
                <label class="form-label">
                  {{ t('client.fixedAssets.quantity') }} <span class="text-danger">*</span>
                </label>
                <input
              ...
              <div class="modal-form__group">
                <label class="form-label">{{ t('client.fixedAssets.unitOfMeasurement') }}</label>
                <select v-model="propertyForm.unitOfMeasurement" class="form-select">
...
.modal-form__properties-list .btn-danger.btn-sm {
